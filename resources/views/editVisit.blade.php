	...
	@if (Auth::user()->level=="admin" || Auth::user()->level=="staff")
        ...
        <p>
          ...
          <p>
            ...
            {!! Form::select('mailedFrom', $mailedFrom_array, $visit->mailLocationNum, array('class' => 'form-control')) !!}
        </p>
        ...
        <p>{!! Form::submit('Submit Changes', array('class' => 'btn btn-primary')) !!}</p>
        {!! Form::close() !!}
	</div>
	</div>
    </div>
